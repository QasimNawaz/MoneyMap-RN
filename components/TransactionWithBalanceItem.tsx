...
import { TransactionWithBalance } from "@/db/query/transactionQueries";
import { useDrizzleDatabase } from "@/hooks/useDrizzleDatabase";
import { fetchSubcategoryById } from "@/db/query/categoryQueries";
import { Account, SubCategory, transactionsTable } from "@/db/schema";
import { theme } from "@/constants/theme";
import { getIconComponent } from "@/assets/icons";
import { fetchAccountById } from "@/db/query/accountQueries";
import { TransactionType } from "@/types/enums";

interface TransactionWithBalanceItemProps {
  transaction: TransactionWithBalance;
}

const TransactionWithBalanceItem: React.FC<TransactionWithBalanceItemProps> = ({
  transaction,
}) => {
    ...
    <View style={styles.transactionItem}>
      ...
      <View style={styles.transactionRight}>
        ...
        <Text style={styles.transactionBalance}>
          (PKR {transaction.closingBalance.formatAmount()})
        </Text>
...
export default TransactionWithBalanceItem;
